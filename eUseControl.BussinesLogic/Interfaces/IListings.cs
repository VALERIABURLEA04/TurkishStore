...
namespace businessLogic.Interfaces
{
    public interface IListings
    {
        ...
        Task CreateListingAsync(CreateListingViewModel model); // Create a new listing from the input model
        Task UpdateListingAsync(int id, CreateListingViewModel model); // Update an existing listing by ID
